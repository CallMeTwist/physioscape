...
class RandomGenerator
{
     ...
     * @throws \Exception
     */
    public static function generate_unique_code(Model $model, $length, $type)
    {
        $code = $type == 'string' ? 'OPHEL-'.self::generate_random_string($length) : self::generate_random_numbers($length);
